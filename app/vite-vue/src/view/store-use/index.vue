 ...
 * @LastEditTime: 2024-06-02 22:53:34
 * @LastEditors: lcc
...
<template>
    <div class="summary">
        <ul>
            ...
            <li>vuex是单一状态树，意味着当越来越多store时，需要嵌套或者更多的命名空间，pinia做到了解耦</li>
        </ul>
    </div>
    <div class="store-container">
        <div class="pinia-container">
            ...
            <button @click="increment">同步添加</button>
            <button @click="reduce">
                异步减少
            </button>
        </div>
        ...
        <div class="vuex-container">
            ...
            <button @click="vuexIncrement">同步添加</button>
            <button @click="vuexReduce">
                异步减少
            </button>
        </div>
    </div>
...
.pinia-container, .vuex-container{
    border-radius:5px;
