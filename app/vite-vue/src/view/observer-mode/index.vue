 ...
 * @LastEditTime: 2024-06-20 03:20:17
 * @LastEditors: lcc
...
<template>
  <m-layout>
    <template #summary>结合代码和查看控制台进行调试</template>
    <template #content>
      <div>
        <m-button @click="addSubscribe">添加观察者到发布者通知名单中</m-button>
        <m-button @click="publishMessage">发布者要发布消息啦</m-button>
      </div>
    </template>
  </m-layout>
</template>
