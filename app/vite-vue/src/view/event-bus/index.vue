 ...
 * @LastEditTime: 2024-06-20 03:26:30
 * @LastEditors: lcc
...
<template>
  <m-layout>
    <template #summary><div>结合代码和查看控制台进行调试</div></template>
    <template #content>
      <m-button @click="subscribe">订阅</m-button>
      <m-button @click="cancelSubscribe">取消订阅added</m-button>
      <m-button @click="emitAdd">发布added</m-button>
      <m-button @click="emitJoin">发布join</m-button>
    </template>
  </m-layout>
</template>
<style></style>
